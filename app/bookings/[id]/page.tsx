...
export default function BookingDetailPage() {
  ...
  if (!booking) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="text-center">
          <p className="text-gray-600 text-base mb-4">Booking not found</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                  {booking.serviceIds.map((service: any, idx: number) => (
                    <div
                      key={idx}
                      className="flex items-start justify-between pb-3 border-b border-gray-200 last:border-0 last:pb-0"
                    >
                      <div>
